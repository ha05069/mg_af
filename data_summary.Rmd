...
The final joined data consists of 39,531 observations of 5824 individual patients (as determined by unique patient identity numbers), across 6779 distinct episodes (as defined by unique CCHIC episode identity numbers).  There were 6776 distinct episodes defined using ICIP episode identity numbers.  

The distribution of number of episodes per patient can be seen below.

```{r,results='asis', echo=FALSE}
# number of observations: 39,531
