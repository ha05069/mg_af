...
```{r}
knitr::include_graphics("./Images/cox_results.png")
```
...
After applying filtering conditions as displayed, we used a dataset of 10,298 windows, with 180 instances of AF. 

There were 669 unique day nurses in this dataset.
